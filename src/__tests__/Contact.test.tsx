...
vi.mock('../components/InteractiveMap', () => ({ default: () => <div data-testid="map">Map</div> }));
...
describe('Contact Component', () => {
    ...
    it('submits form with valid data', async () => {
        ...
        vi.mocked(ApiService.submitContactForm).mockResolvedValue({ success: true, message: 'Success' });
        ...
        await user.type(screen.getByLabelText(/message/i), 'This is a test message longer than 10 chars');
